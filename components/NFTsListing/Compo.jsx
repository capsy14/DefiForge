...
function Compo() {
  ...
  return (
    <div className="flex items-center justify-center flex-col mt-28 ml-8 mr-28 mb-10">
      ...
      {nfts.map((nft, index) => (
        <div
          className="mt-5 pl-5 hover:scale-105 transition duration-1000 "
          key={index}
        >
            ...
            action={(cntr) => {
              cntr.erc1155
                ...
                .then((response) => {
                  ...
                  alert(
                    `Congratulations! You've successfully claimed your NFTs. To import them into your MetaMask account, click on "Import NFTs" and use the following details: Contract Address: 0xa3aBB24C7CBb22E56AfFef3e4751163B0176dbDf, TokenID: ${nft.metadata.id}.`
                  );
                })
                .catch((error) => {
                  // Handle the error
